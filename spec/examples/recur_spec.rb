...
describe :occurring_between? do
  ...
  let(:schedule) do
    IceCube::RecurrenceSchedule.new(start_time, :duration => 30).tap do |schedule|
...
describe :next_occurrence do
  ...
  it 'should get the next occurrence from now' do
    ...
    schedule = RecurrenceSchedule.new(start_time, :end_time => start_time + 24 * ONE_HOUR)
...
describe :next_occurrences do
  ...
  it 'should get the next 3 occurrence from now' do
    ...
    schedule = RecurrenceSchedule.new(start_time, :end_time => start_time + ONE_HOUR * 24)
    schedule.add_recurrence_rule(Rule.hourly)
  ...
  it 'should get the next 3 occurrence past the end of the year' do
    schedule = RecurrenceSchedule.new(Time.now, :end_time => Time.now + ONE_HOUR * 24)
